...
FROM ITMFACILIT T1
	...
	LEFT JOIN (SELECT 	T1.MFGFCY_0,T1.ITMREF_0,SUM(T1.RETQTY_0 - T1.USEQTY_0) QTY_0 FROM MFGMAT T1	LEFT JOIN MFGHEAD T2 ON T1.MFGNUM_0 = T2.MFGNUM_0 WHERE T2.MFGSTA_0 <> '4' AND T1.MATSTA_0 < '3' GROUP BY T1.MFGFCY_0,T1.ITMREF_0 ) T7 ON T1.ITMREF_0 = T7.ITMREF_0 AND T1.STOFCY_0 = T7.MFGFCY_0
...
SELECT * FROM STOALL WHERE ITMREF_0 = 'MCT2698' AND STOFCY_0 = '0201'

DELETE FROM STOALL WHERE ITMREF_0 = 'MCT2698' AND STOFCY_0 = '0201'
...
WHERE T1.SOHNUM_0 = '0101SOH17080045' AND T1.ITMREF_0 = 'ISQ0077-DYN'