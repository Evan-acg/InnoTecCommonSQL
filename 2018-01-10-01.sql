...
FROM MFGMAT A
 ...
 INNER JOIN (SELECT STOFCY_0,ITMREF_0,REOCOD_0,B.LANMES_0 FROM ITMFACILIT A INNER JOIN APLSTD B ON A.REOCOD_0=B.LANNUM_0 AND  B.LANCHP_0=250 AND B.LAN_0='CHI') F ON A.ITMREF_0= F.ITMREF_0 AND A.MFGFCY_0= F.STOFCY_0
 LEFT JOIN APLSTD G ON A.MATSTA_0 = G.LANNUM_0 AND LAN_0 = 'CHI' AND LANCHP_0 = '363'
WHERE  E.MFGSTA_0<>4 
 AND A.RETQTY_0 - A.USEQTY_0 >0
	AND A.MFGNUM_0 = N'0203MFG18010478'
	AND A.ITMREF_0 = N'IVF1601'
--WHERE A.MFGFCY_0 = N'0203'
--	AND A.MFGNUM_0 = N'0203MFG18010478'
--	AND A.ITMREF_0 = N'IVF1601'
